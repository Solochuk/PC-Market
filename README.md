...
1.Каталог товарів
2.Сторінка товару(фото, опис)
3.Кошик покупця
4.Оформлення замовлення
5.Адмін-панель для додавання/редагування товарів
...
1.cd project_1
2.python manage.py migrate(якщо бази даних немає!)
3.python manage.py createsuperuser(опціонално, для створення адміна)
